...
async def song(client, message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = await message.reply(f"**Searching The Song\n {query}**")
    ...
    try:
        ...
        performer = f"[IBM NETWORKS]" 
        duration = results[0]["duration"]
        url_suffix = results[0]["url_suffix"]
        views = results[0]["views"]
    except Exception as e:
        print(str(e))
        return await m.edit("Example: /song Mere Bina song")
    ...
    try:
        ...
        cap = "**BY›› [IBM NETWORKS](https://t.me/IBMBotSupport)**"
